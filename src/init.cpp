...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/florincoin-project/florincoin>";
    const std::string URL_WEBSITE = "<https://florincoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Florincoin version %s\n", FormatFullVersion());
}
